    ...
    <table class="search" style="width:100%;">
        <tr>
            <?=$this->Form->create(null,['url'=>['action'=>'profile_list']]) ?>
                <td><?=$this->Form->text("search", ['style'=>"width:80%; padding:1em;", 'class'=>'searchTxtbox', 'placeholder'=>'名前・所属からの検索', ['size'=>400]]) ?></td>
...
<?php  foreach($account as $obj): ?>
    <table id = "myProfile" style = "margin-top:3%;">
        <td id = "myPhoto">
            <?=$this->Html->image($obj->ICON_URL, ['class'=>'myIcon', 'style'=>'width:200px; height:200px;']) ?>
        </td>
        <td id = "myInformation">
