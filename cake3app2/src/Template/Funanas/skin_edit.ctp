...
<?=$this->Form->end() ?>
<?=$this->Form->create($entity,['type'=>'post', 'url'=>['action'=>'skin']]) ?>
    <div id="editSaveBtn">
    ...
    <?php foreach($data as $obj): ?>
        <div id="skinEditTxt">
            ...
            <?=$this->Form->text("REAL_NAME",['style'=>"width:30em; padding:1em;", 'class'=>'editTxtbox', 'value'=>$obj->REAL_NAME, ['size'=>100]]) ?><br/>
            <div id="editBelTxt">所属</div>
            <?=$this->Form->text("TEAM",['style'=>"width:30em; padding:1em;", 'class'=>'editTxtbox', 'value'=>$obj->TEAM, ['size'=>100]]) ?><br/>
            <div id="editSubTxt">得意科目</div>
            <?=$this->Form->text("SUBJECT",['style'=>"width:30em; padding:1em;", 'class'=>'editTxtbox', 'value'=>$obj->SUBJECT, ['size'=>100]]) ?><br/>
        </div>
        <table id="tbEditSkin">
            <tr class="radio02">
