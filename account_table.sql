...
--
-- Host: 127.0.0.1
-- Generation Time: 2018 年 5 朁E07 日 07:59
...
--
-- テーブルのデータのダンプ `account table`
--

INSERT INTO `account table` (`ID`, `MAil`, `PASS`, `QRPASS`, `PHONE`, `NAME`, `PREMIA`, `SKIN_ID`, `FRUIT_ID`, `QR_URL`, `ICON_URL`) VALUES
